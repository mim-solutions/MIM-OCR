...
# -- Python --
RUN apt-get install -y python${python_version} python${python_version}-dev python${python_version}-distutils python${python_version}-setuptools curl build-essential protobuf-compiler
